...
<body>
	...
	<div class="e_div2">
		<form action="New/register_p.do" autocomplete="off" id="form1"
			method="post">
			<div>
				<div class="e_box1">用户名：</div>
				<div class="e_box2">
					<input id="name" name="name" class="e_i1" type="text"
						placeholder="（由2~30位字符组成）" onblur="test1()" maxlength="30">
				</div>
			...
			<div>
				...
				<div class="e_box2">
					<input id="code" class="e_i1" type="password" name="code"
				...
				<div class="e_box2" style="margin-top: 21px;">
					<div class="checkboxFour">
						<input type="checkbox" name="agree" id="agree" /> <label
							for="checkboxFourInput"></label> <label for="agreement"
							style="font-weight:bold;">您已阅读并接受《道格-个人版用户服协议》</label>
					</div>
				</div>
