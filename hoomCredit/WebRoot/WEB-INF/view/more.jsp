...
.add_color {
	color: #FF5B59;
	background: url(...../../image/individual/h_95.png) no-repeat -8px -3px
		!important;
	...
	<div class="a1">
		<div class="a1_d1">
			<div class="sea1_dd1">
				...
				<ul id="ul">
					<a href="<%=basePath%>New/queryLog.do"><li id="serch" class="add_color">查询记录</li></a>
			...
			<div class="a1_d11">
				...
				<div class="sea2_dd1">
					...
					<div id="Searchresult"
						style="height:473px;width:810px;background:#FDFDFE;/* border-bottom:1px solid #ccc; */padding-left: 30px;color:#919191;font-size: 14px;">
					</div>
										...
										<div class="sea2_d2">
											...
											<ul class="s_u2">
											   ...
											   <li class="l4"><span>初级</span></li>
												<li class="l5">
												<a
													href="New/record.do?port=${list.port }&num=${list.num}"><span>查看</span>
												</a>
												</li>
											    </c:when>
											   ...
											   <li class="l4"><span>中级</span></li>
												...
												<c:if test="${list.other > 2}">
												<a href="first/middleshow.do?num=${list.num}"><span>查看</span>
												</a>
												</c:if>
												<c:if test="${list.other <= 2}">
												<a><span style="color: gray;border: 1px solid gray;background: #F2F3F5;">查看</span>
												</a>
												</c:if>
							...
							<div class="sea2_d2">
								...
								<ul class="s_u2">
									...
									<li class="l22">类别： <c:if test="${u1.usertype=='1' }">个人</c:if>
										<c:if test="${u1.usertype=='0' }">企业</c:if>
									</li>
