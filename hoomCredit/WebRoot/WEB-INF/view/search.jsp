...
<body>
	...
	<div class="home3">
		<div
			style="width:1200px;margin:auto;height:100%;background: white;text-align:left;">
			<div
				style="width:610px;    margin-left: 30px;border:0px solid #ccc;height:100%;">


				<div style="height:50px;">
					<!-- form -->
					<div class="sch_form">
						<form id="bdfm2" action="New/primary.do">
		...
		<a href="New/primary.do" class="cate active" id="pp">个人</a >
		<a href="New/primarys.do" class="cate" id="cc">企业</a>
		<!-- <a class="cate">专利</a>
		<a class="cate">商标</a>
		<a class="cate">产品品牌</a>
		<a class="cate">联系方式</a>
	...
	<div class="sea2" id="personal">
		...
		<div class="sea2_dd">
			...
			<div
				...
				<span class="sea2_s21">个人</span> <span class="sea2_s22">姓名</span> <span
					class="sea2_s23">年龄</span> <span class="sea2_s24">状态</span>
			</div>

			<div id="Searchresult" style="margin-left:30px;"></div>

			<div id="hiddenresult" style="display:none;">
				<c:forEach items="${personList}" var="list" varStatus="abc">


					<div class="result">
						<c:forEach items="${personList}" var="list" begin="${abc.index*5}"
							end="${(abc.index+1)*5-1}">
							...
							<div
								...
								<div class="sea2_d2">
									<ul class="sea2_u1">
										<a href="New/personDetail.do?a1=${list.a1}">${list.name}</a>
									</ul>
									<ul class="s_u2">
										<li class="l1">身份证号码：${list.orgno}</li>
										<li class="l2">${list.sexy}</li>
										<li class="l3">${list.age}</li>
										<li class="l4"><span>${list.cate}</span>
										</li>
									</ul>
									<ul class="sea2_u3">省份：${list.province }
									</ul>
								</div>
							</div>
